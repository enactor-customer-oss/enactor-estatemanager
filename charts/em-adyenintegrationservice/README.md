...
![Version: 1.1.6](https://img.shields.io/badge/Version-1.1.6-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.7](https://img.shields.io/badge/AppVersion-2.7-informational?style=flat-square)

Adyen Integration Service - Part of the Enactor Estate Manager Stack
...
| application.name | string | `"em-adyenintegrationservice"` |  |
| application.nameShort | string | `"ais"` |  |
...
| image.repository | string | `"lin/ais"` |  |
| image.tag | string | `""` |  |
...
| service.ports.http | int | `39895` |  |
| service.ports.https | int | `52305` |  |
